...
const ConfirmationModal = ({
  ...
  const styles = {
    danger: {
      ...
      bgIcon: "bg-red-50",
      btnConfirm: "bg-red-400 hover:bg-red-500 text-white shadow-red-200",
      textTitle: "text-red-900"
    },
    success: {
      icon: <CheckCircle className="text-purple-500" size={24} />,
      bgIcon: "bg-purple-50",
      btnConfirm: "bg-purple-400 hover:bg-purple-500 text-white shadow-purple-200",
      textTitle: "text-purple-900"
    },
    warning: {
      icon: <AlertTriangle className="text-orange-400" size={24} />,
      bgIcon: "bg-orange-50",
      btnConfirm: "bg-orange-300 hover:bg-orange-400 text-white shadow-orange-100",
      textTitle: "text-orange-900"
    },
    info: {
      icon: <Info className="text-blue-400" size={24} />,
      bgIcon: "bg-blue-50",
      btnConfirm: "bg-blue-300 hover:bg-blue-400 text-blue-900 shadow-blue-100",
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl w-full max-w-sm overflow-hidden scale-100 animate-in zoom-in-95 duration-200 border dark:border-slate-700 transition-colors">
        ...
        <div className="p-6 text-center">
          ...
          <h3 className={`text-lg font-bold mb-2 ${style.textTitle} dark:text-white`}>
            {title}
          </h3>
          ...
          <div className="flex gap-3 justify-center">
            {!isAlert && (
              <button
                onClick={onClose}
                className="flex-1 px-4 py-2 bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-200 font-medium rounded-lg hover:bg-slate-200 dark:hover:bg-slate-600 focus:outline-none focus:ring-2 focus:ring-slate-100 transition"
              >
                {cancelText}
              </button>
            )}
